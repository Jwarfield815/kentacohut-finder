...
export const fileChecker = async () => {
    let tbAllLocations = await fsp.readFile('./locations/tacobell/tbAllLocations.txt', 'utf8', (err, data) => {});
    let phAllLocations = await fsp.readFile('./locations/pizzahut/phAllLocations.txt', 'utf8', (err, data) => {});
    let kfcAllLocations = await fsp.readFile('./locations/kfc/kfcAllLocations.txt', 'utf8', (err, data) => {});
    let kfcTacoBellCombos = await fsp.readFile('./locations/combos/extraKfcTacoBells.txt', 'utf8', (err, data) => {});
